/**
** 文章索引 http://blog.csdn.net/maozefa/article/details/7188537
**/
#ifndef _BMPDATA_H_
#define _BMPDATA_H_
...
FORCEINLINE
VOID GetBitmapData(INT width, INT height, INT stride, LPVOID scan0,ImagePixelFormat format, BOOL isAlpha, BitmapData *data)
{
